...
4. Wire the capability through the service provider using the patterns in _Provider wiring_ below.
...
5. Name publish tags with the `refit-*` convention so consumers can target individual resource groups.
